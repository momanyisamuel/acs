...
const ServiceCard: React.FC<ServiceItem> = ({ title, image, link }) => (
  <Link to={link} className="group flex flex-col h-full bg-white shadow-sm hover:shadow-lg transition-shadow border border-gray-100">
    {/* Image Container */}
    ...
    <div className="p-8 flex items-center justify-center text-center min-h-[120px] bg-white relative z-10">
       <div className="text-[#8C41D2] font-bold uppercase text-xl leading-tight tracking-tight">
         {title}
       </div>
    </div>

    {/* Footer Button */}
    <div className="mt-auto bg-[#8C41D2] py-4 px-6 flex justify-between items-center text-white text-xs font-bold uppercase tracking-wider group-hover:bg-[#6B2FA8] transition-colors cursor-pointer">
  ...
  return (
    <div className="font-sans flex flex-col min-h-screen bg-white">
      ...
      <section className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-16 text-center">
        ...
        <div className="border border-[#FC7801] border-dashed p-1 inline-block mb-10 shadow-sm max-w-4xl mx-auto bg-white">
           <div className="border border-[#FC7801] px-6 py-6 md:px-16 md:py-8 bg-white">
        ...
        <div className="max-w-6xl mx-auto text-gray-500 text-sm md:text-base leading-relaxed text-justify md:text-left mb-8">
          <p>
            <span className="font-bold text-[#FC7801]">Accessibility Community Supports</span> offers everything necessary to help you and your loved ones flourish in your community. Our skilled professionals are available to deliver care and community activities to promote independence and achieve your aspirations. We’ll help you reach your full potential by providing a variety of services tailored to your unique requirements. We believe that everyone deserves the opportunity to contribute to their community, and we are here to help make this a reality.
          </p>
        </div>
      </section>
