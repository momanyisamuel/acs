      ...
      <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="text-center mb-12">
          <div className="inline-flex items-center justify-center p-3 bg-blue-50 rounded-full mb-4">
            <Sparkles className="h-8 w-8 text-[#8C41D2]" />
          </div>
          <h1 className="text-4xl font-extrabold text-[#8C41D2] mb-4">Community Support Assistant</h1>
        ...
        {/* Input Form */}
        <div className="bg-white rounded-2xl shadow-lg p-8 mb-10 border-t-4 border-[#FC7801]">
          <form onSubmit={handleGenerate} className="space-y-6">
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
              <div>
                ...
                <input
                  ...
                  className="w-full border-gray-300 rounded-lg border p-3 focus:ring-2 focus:ring-[#8C41D2] focus:border-[#8C41D2] outline-none transition-all"
                />
              </div>
              <div>
                ...
                <select
                  ...
                  className="w-full border-gray-300 rounded-lg border p-3 focus:ring-2 focus:ring-[#8C41D2] focus:border-[#8C41D2] outline-none transition-all bg-white"
                >
            ...
            <button
              type="submit"
              disabled={loading}
              className="w-full flex items-center justify-center bg-[#FC7801] hover:bg-[#D96600] text-white font-bold py-4 rounded-lg transition-colors disabled:opacity-50 disabled:cursor-not-allowed uppercase tracking-wider"
            >
              {loading ? (
                <>
        ...
        {result && (
          <div className="bg-white rounded-2xl shadow-lg border border-gray-100 overflow-hidden animate-fade-in">
            <div className="bg-[#8C41D2] px-8 py-6 text-white">
            ...
            <div className="p-8 space-y-8">
              ...
              <div className="space-y-3">
                <h3 className="flex items-center text-lg font-bold text-[#FC7801] uppercase tracking-wide">
                  ...
                  {result.steps.map((act, i) => (
                    <div key={i} className="p-4 hover:bg-gray-50 transition-colors">
                      <div className="flex justify-between items-start mb-1">
                        <h4 className="font-bold text-[#8C41D2]">{act.name}</h4>
                        <span className="text-xs font-mono bg-blue-50 text-[#8C41D2] px-2 py-1 rounded">{act.time}</span>
                      </div>
