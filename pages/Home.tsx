...
const ServiceCard: React.FC<{ title: React.ReactNode; image: string; link?: string }> = ({ title, image, link }) => (
  <div className="group relative flex flex-col h-full bg-white shadow-sm hover:shadow-lg transition-shadow">
    <div className="relative h-72 overflow-hidden">
      ...
      <div className="absolute bottom-0 left-0 right-0 p-5 bg-white/95 mx-4 mb-4 shadow-sm text-center min-h-[80px] flex items-center justify-center">
         <div className="text-[#004b8d] font-bold uppercase text-base leading-tight tracking-tight">
           {title}
         </div>
      </div>
    </div>
    <div className="mt-auto bg-[#004b8d] py-3 px-4 flex justify-between items-center text-white text-xs font-bold uppercase tracking-wider group-hover:bg-[#003666] transition-colors cursor-pointer">
  ...
  return (
    <div className="flex flex-col min-h-screen font-sans">
      ...
      <section className="relative h-[650px] w-full">
        ...
        <div className="relative max-w-7xl mx-auto h-full px-4 sm:px-6 lg:px-8 flex items-center">
          <div className="bg-white p-10 md:p-14 max-w-lg shadow-2xl animate-fade-in-up">
            ...
            <div className="text-[#004b8d] text-4xl font-light leading-none mb-1">FOR A</div>
            <h1 className="text-[#e31837] text-6xl md:text-7xl font-extrabold leading-[0.9] mb-4 tracking-tight">
      ...
      <section className="bg-white pt-20 pb-10 text-center">
        <div className="inline-block bg-[#e31837] text-white text-[10px] font-bold px-3 py-1.5 uppercase tracking-widest mb-5">
          What We Do
        </div>
        <h3 className="text-gray-400 font-light text-2xl uppercase tracking-wide mb-1">We Offer The Following</h3>
        <h2 className="text-[#004b8d] text-5xl md:text-6xl font-bold uppercase tracking-tight mb-6">Services</h2>
      ...
      <section className="w-full bg-white">
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 min-h-[600px]">
          ...
          <div className="flex flex-col h-full">
            ...
            <div className="h-1/2 bg-[#004b8d] p-10 flex flex-col justify-center items-start text-white hover:bg-[#003666] transition-colors group cursor-pointer relative overflow-hidden">
          ...
          <div className="flex flex-col h-full">
            <div className="h-1/2 bg-[#e31837] p-10 flex flex-col justify-center items-center text-center text-white hover:bg-[#c41530] transition-colors group cursor-pointer relative overflow-hidden">
               <div className="relative z-10">
          ...
          {/* Column 3 & 4 (Right - Large Blue Box) */}
          <div className="md:col-span-2 lg:col-span-2 bg-[#004b8d] p-12 md:p-20 flex flex-col justify-center relative overflow-hidden">
             <div className="relative z-10 max-w-2xl">
               <div className="inline-block border border-white/30 text-white text-[10px] font-bold px-3 py-1.5 uppercase tracking-widest mb-8 bg-[#e31837]">
                 Welcome To
               </div>
               <h2 className="text-5xl md:text-6xl font-bold text-white mb-2 uppercase tracking-tight">Inspiring</h2>
               <h3 className="text-3xl md:text-4xl font-light text-white mb-8 uppercase tracking-wide">Community Supports</h3>
               <p className="text-white/80 text-sm md:text-base leading-relaxed mb-8">
                 Looking for structured community care that puts your needs first? ICS is all about empowering you to live your life to the fullest. We offer a range of person-centered services that are right for you, including transportation, community support, and more, to help you thrive in your community.
               </p>
             </div>
             {/* Decorative Elements */}
      ...
      <section className="bg-white relative">
        <div className="grid grid-cols-1 lg:grid-cols-2">
          <div className="p-12 md:p-24 flex flex-col justify-center items-start">
             <div className="bg-[#e31837] text-white text-[10px] font-bold px-3 py-1.5 uppercase tracking-widest mb-8 inline-block">
               We Are Committed
             </div>
             <h2 className="text-[#004b8d] text-5xl md:text-6xl font-bold uppercase mb-0 leading-none">Our Mission</h2>
             ...
             <Link to="/about" className="bg-[#e31837] text-white px-8 py-5 flex items-center gap-6 hover:bg-[#c41530] transition-colors shadow-lg group">
      ...
      <section className="py-24 relative bg-white">
        <div className="max-w-4xl mx-auto px-4 text-center">
          <div className="inline-block bg-[#e31837] text-white text-[10px] font-bold px-3 py-1.5 uppercase tracking-widest mb-6">
             Reach Out To Us
          </div>
          <h2 className="text-5xl text-gray-700 uppercase mb-2 font-light tracking-tight">Send Us A <span className="text-[#004b8d] font-bold">Message</span></h2>
          ...
          <form className="space-y-4 text-left max-w-3xl mx-auto">
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
               <input type="text" placeholder="Full Name" className="w-full bg-[#f8f9fa] border border-gray-200 p-4 text-sm focus:outline-none focus:border-[#004b8d] transition-colors placeholder-gray-400" />
               <input type="email" placeholder="Email Address" className="w-full bg-[#f8f9fa] border border-gray-200 p-4 text-sm focus:outline-none focus:border-[#004b8d] transition-colors placeholder-gray-400" />
            </div>
            <textarea rows={5} placeholder="Message(s)" className="w-full bg-[#f8f9fa] border border-gray-200 p-4 text-sm focus:outline-none focus:border-[#004b8d] transition-colors placeholder-gray-400 resize-none"></textarea>
            <div className="flex flex-col md:flex-row justify-between items-center gap-6 mt-8">
              ...
              <button className="bg-[#e31837] text-white font-bold py-4 px-12 hover:bg-[#c41530] transition-colors shadow-lg uppercase tracking-wider flex items-center gap-2 w-full md:w-auto justify-center text-sm">
        ...
        {/* Bottom Green Image Strip */}
        <div className="w-full h-56 mt-20 overflow-hidden relative">
           <div className="absolute inset-0 bg-gradient-to-t from-white via-white/50 to-transparent z-10"></div>
           <img src="https://images.unsplash.com/photo-1501854140884-074bf86ee95c?auto=format&fit=crop&q=80&w=2000" className="w-full h-full object-cover object-bottom" alt="Nature footer" />
        </div>
      </section>
