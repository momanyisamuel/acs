...
const Footer: React.FC = () => {
  return (
    <footer className="w-full font-sans">
      {/* Red Contact Bar */}
      <div className="bg-[#e31837] text-white relative">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12 flex flex-col md:flex-row justify-between items-center gap-8 relative z-10">
          ...
          <div className="flex flex-col items-center justify-center text-center">
             <div className="bg-white rounded-full p-2 h-24 w-24 flex items-center justify-center mb-3 shadow-lg">
                <img src="https://cdn-icons-png.flaticon.com/512/2942/2942544.png" alt="Logo" className="w-16 h-16 opacity-90" />
             </div>
          ...
          <div className="flex items-center gap-8 md:mr-10">
            ...
            <div className="text-center md:text-left">
              ...
              <div className="text-base opacity-95 space-y-1">
                <p><span className="font-bold">Phone:</span> 908-827-1109</p>
                <p><span className="font-bold ml-[54px]"></span> 908-405-1979</p>
                <p className="mt-2"><span className="font-bold">info@inspiringcs.org</span> - Community Services</p>
              </div>
            </div>
          </div>
        </div>
      ...
      {/* Bottom Nav Bar */}
      <div className="bg-[#004b8d] text-white py-8 border-t border-[#003666]">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 flex flex-col md:flex-row justify-between items-center gap-6 text-[11px] font-bold uppercase tracking-widest">
          <div className="flex flex-wrap justify-center gap-8">
            ...
            <Link to="/about" className="hover:text-gray-300 transition-colors">ICS</Link>
      ...
      <div className="fixed bottom-8 right-8 z-50">
        <button className="bg-[#e31837] text-white p-3 rounded-full shadow-xl hover:bg-[#c41530] transition-colors border-2 border-white animate-bounce-slow">
